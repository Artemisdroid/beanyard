...
.forms .form-content .button input{
  color: #fff;
  background: linear-gradient(to left, #7d2ae8 0% , #ff0080 100%);
  border-radius: 6px;
  padding: 0;
  cursor: pointer;
...
if(isset($_POST['submit']))
{
	...
	else 
	{
		...
		{
			$insertquery = "insert into signup (name,email,password,cpassword,contact) values ('$username', '$email',  '$pass', '$cpass', '$contact')";
